...
[task_local]
#东东健康社区
13 1,6,22 * * * jd_health2.js, tag=东东健康社区, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "13 1,6,22 * * *" script-path=jd_health2.js, tag=东东健康社区

====================Surge================
东东健康社区 = type=cron,cronexp="13 1,6,22 * * *",wake-system=1,timeout=3600,script-path=jd_health2.js
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `https://api.11111117/api/health/${randomCount}`, 'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
