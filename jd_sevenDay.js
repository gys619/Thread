...
if (process.env.SEVENDAY_LIST) {
    activityIdList = [...process.env.SEVENDAY_LIST.split('&'), ...activityIdList]
}
if (!activityIdList.length) {
    console.log('无店铺签到activityId,不执行.需自备activityId:环境变SEVENDAY_LIST: id1&id2.')
    return
}
const $ = new Env('7天店铺签到');
