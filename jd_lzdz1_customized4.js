...
!(async () => {
  ...
  // authorCodeList = await getAuthorCodeList('https://gitee.com/11111131/Code/raw/master/lzdz3.json')
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      authorCodeList = [
        "ba518a62a17e4effae83505caf9dfc23",
        "a04203b55a884da39b7cf90f623bfc4e",
        "34a9106e9ade4d7c86a2cd0522164f58",
      ];
      // $.authorCode = authorCodeList[random(0, authorCodeList.length)];
      $.authorCode = ownCode ? ownCode : authorCodeList[random(0, authorCodeList.length)]
      $.authorNum = `${random(1000000, 9999999)}`;
      $.randomCode = random(1000000, 9999999);
      $.activityId = "dz4dd4f0fcb0f843af965130a7697f";
      $.activityShopId = "1000097462";
      $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/drinkcategory/piecetoge/activity/${$.authorNum}?activityId=${$.activityId}&shareUuid=${encodeURIComponent($.authorCode)}&adsource=null&shareuserid4minipg=${encodeURIComponent($.secretPin)}&shopid=${$.activityShopId}&sid=&un_area=`;
      await member();
      await $.wait(1000);
      if ($.bean > 0) {
