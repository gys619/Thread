            ...
            if ($.activityContent) {
                ...
                if ($.activityContent.canJoin) {
                    ...
                    if (!$.activityContent.openCard) {
                        ...
                        await bindWithVender({ "venderId": "1000002527", "shopId": "1000002527", "bindByVerifyCodeFlag": 1, "registerExtend": {}, "writeChildFlag": 0, "activityId": 3282318, "channel": 401 }, 1000002527)
                    }
