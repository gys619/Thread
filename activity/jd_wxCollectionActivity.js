...
//自己有就在配置文件中加变量 COLLECTION_ID || "";  //活动ID  以逗号分隔  111,22,33
*/
...
!(async () => {
    ...
    //let activityIdList = await getActivityIdList('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/wxCollection.json')
    // let activityIdList = [
    // ]
