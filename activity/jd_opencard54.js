...
function shopactivityId(functionId) {
    return {
        ...
        headers: {
            ...
            'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${functionId}&shopId=${functionId}&venderType=5&channel=401&returnUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/689126?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            'Cookie': cookie
        }
    }
}
    ...
    return new Promise(resolve => {
        $.post({
            ...
            headers: {
                ...
                'Referer':`https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/689126?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
...
function adLog() {
    return new Promise(resolve => {
        let pageurl = `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/689126?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
        $.post({
...
function getHtml() {
    return new Promise(resolve => {
        $.get({
            url: `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/689126?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            headers: {
                'User-Agent': $.UA,
                'Host':'lzdz1-isv.isvjcloud.com',
