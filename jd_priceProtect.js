/*
cron "5 2 * * *" jd_priceProtect.js
京东价格保护
脚本兼容: QuantumultX, Node.js
==========================Quantumultx=========================
[task_local]
# 京东价格保护
cron "5 2 * * *" jd_priceProtect.js, tag=京东价格保护, img-url=https://raw.githubusercontent.com/ZCY01/img/master/pricev1.png, enabled=true
*/
...
async function skuOnceApply(token) {
    let body = { "sid": "", "type": "3", "forcebot": "", "token": token }
    return new Promise(resolve => {
                ...
                if (err) {
                    ...
                    if (data) {
                        if (data.flag) {
                            ...
                            console.log(`保价失败，原因：${data.responseMessage}`)
                        }
                    }
                }
            } catch (e) {
