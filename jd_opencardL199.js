...
最少开卡一张才能邀请，自测
————————————————
入口：[ 7.22-8.6 超燃好物 七夕献礼 ]

请求太频繁会被黑ip
过10分钟再执行

cron:25 1,13 23-31,1-6 7,8 *
============Quantumultx===============
[task_local]
#7.22-8.6 超燃好物 七夕献礼
25 1,13 23-31,1-6 7,8 * jd_opencardL199.js, tag=7.22-8.6 超燃好物 七夕献礼, enabled=true
...
!(async () => {
    ...
    // authorCodeList = await getAuthorCodeList('https://gitee.com/11111131/Code/raw/master/lzdz1.json')
