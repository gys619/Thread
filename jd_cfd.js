...
更新时间：2021-11-16
活动入口：京喜APP-我的-京喜财富岛
from：https://github.com/222222/sync/tree/jd_scripts
已支持IOS双京东账号,Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
============Quantumultx===============
[task_local]
#京喜财富岛
5 * * * * https://raw.githubusercontent.com/11111115/JDHelp/main/jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
================Loon==============
[Script]
cron "5 * * * *" script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_cfd.js,tag=京喜财富岛
===============Surge=================
京喜财富岛 = type=cron,cronexp="5 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_cfd.js
============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_cfd.js, cronexpr="5 * * * *", timeout=3600, enable=true
*/
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({
      url: `http://www.11111114/jdcodes/getcode.php?type=jxcfd&num=10`,
      'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
