...
[task_local]
#京喜财富岛
45 0-23/2 * * * https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
================Loon==============
[Script]
cron "45 0-23/2 * * *" script-path=https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd.js,tag=京喜财富岛
===============Surge=================
京喜财富岛 = type=cron,cronexp="45 0-23/2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd.js
============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd.js, cronexpr="45 0-23/2 * * *", timeout=3600, enable=true
 */
!function (t, r) { "object" == typeof exports ? module.exports = exports = r() : "function" == typeof define && define.amd ? define([], r) : t.CryptoJS = r() }(this, function () {
  ...
  !(async () => {
    ...
    if (!res) {
      $.http.get({url: 'https://purge.jsdelivr.net/gh/11111129/11111128@main/shareCodes/11111127'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
      await $.wait(1000)
