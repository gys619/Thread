...
[task_local]
#京喜牧场
20 * * * * https://raw.githubusercontent.com/11111115/JDHelp/main/jd_jxmc.js, tag=京喜牧场, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 * * * *" script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_jxmc.js,tag=京喜牧场

===============Surge=================
京喜牧场 = type=cron,cronexp="20 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_jxmc.js

============小火箭=========
京喜牧场 = type=cron,script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_jxmc.js, cronexpr="20 * * * *", timeout=3600, enable=true
 */
...
function getAuthorShareCode(url='https://raw.githubusercontent.com/11111115/params/main/jxmc.json') {
  return new Promise(async resolve => {
    const options = {
