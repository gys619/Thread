...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://raw.githubusercontent.com/okyyds/duck/master/code/11111127')
  if (!$.res) {
    $.http.get({url: 'https://raw.githubusercontent.com/okyyds/duck/master/code/11111127'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
