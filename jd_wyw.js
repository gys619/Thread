...
===============Surge=================
玩一玩成就 = type=cron,cronexp="0 8,22 * * *",wake-system=1,timeout=3600,script-path=jd_wyw.js

============小火箭=========
玩一玩成就 = type=cron,script-path=jd_wyw.js, cronexpr="0 8,22 * * *", timeout=3600, enable=true
*/
const $ = new Env('玩一玩成就');
