...
!(async () => {
    ...
    const link = Math.random() > 0.5 ? 'https://raw.fastgit.org/123/updateTeam/main/shareCodes/kyd.json' : 'https://raw.fastgit.org/123/updateTeam/main/shareCodes/kyd.json'
