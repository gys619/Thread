...
[task_local]
#1.8~1.26 集年味卡，享年味盛宴
30 2 27,9-26/3 1 * https://raw.githubusercontent.com/11111120/scripts/master/gua_opencard101.js, tag=1.8~1.26 集年味卡，享年味盛宴, enabled=true
...
async function run() {
  try {
    ...
    if(($.hasEnd === true || Date.now() > $.endTime) && nowTime > new Date('2022/01/28 00:00:00+08:00').getTime()){
      $.activityEnd = true
      console.log('活动结束')
      return
    }
