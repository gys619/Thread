...
async function travel() {
    try {
        ...
        const tigernian_koiLottery = await doApi("koiLottery")
        console.log(JSON.stringify(tigernian_koiLottery))
    } catch (e) {
        console.log(e)
    }
}
...
async function doApi(functionId, prepend = {}, append = {}, needSs = false, getLast = false) {
    ...
    const bodyMain = objToStr2({
        ...
        body: encodeURIComponent(JSON.stringify({
            ...prepend,
            ss: needSs ? await getSs($.secretp || "E7CRMoDURcyS-_XDYYuo__Ai9oE") : undefined,
            ...append,
        })),
        client: "wh5",
        clientVersion: "1.0.0"
