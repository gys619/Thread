...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '6113f6c322ca4411bb0384fdfe86089f',
                '7a198c42df6649cc8af93863abe3b1ca',
                'd4c09853092144009661480cc6badd44',
                '3d133924b477413ab9273874f1099208',
                '2136743635554939b65a0a5fd9bc86e8',
                '63a8a02aa2e34204bbcf445e7dd7e1c0',
                '6ba0070b6d554ef49e0a515e26f8d61d',
            ]
            // $.authorCode = authorCodeList[random(0, authorCodeList.length)]
            $.authorCode = ownCode ? ownCode : authorCodeList[random(0, authorCodeList.length)]
            $.authorNum = `${random(1000000, 9999999)}`
            $.randomCode = random(1000000, 9999999)
            $.activityId = '2208100037674501'
