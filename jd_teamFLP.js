...
————————————————
入口：[组队分豆-飞利浦 (https://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=52c0712263f342308da1287a66702009&signUuid=efe2fa52a4fb483eb85cee748d070561)]
IOS等用户直接用NobyDa的jd cookie
============Quantumultx===============
[task_local]
#组队分豆-飞利浦
3 0,12 * * * https://raw.githubusercontent.com/11111115/JDHelp/main/jd_teamFLP.js, tag=组队分豆-飞利浦, enabled=true
================Loon==============
[Script]
cron "3 0,12 * * *" script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_teamFLP.js,tag=组队分豆-飞利浦
===============Surge=================
组队分豆-飞利浦 = type=cron,cronexp="3 0,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_teamFLP.js
============小火箭=========
组队分豆-飞利浦 = type=cron,script-path=https://raw.githubusercontent.com/11111115/JDHelp/main/jd_teamFLP.js, cronexpr="3 0,12 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=52c0712263f342308da1287a66702009&signUuid=efe2fa52a4fb483eb85cee748d070561`)
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['efe2fa52a4fb483eb85cee748d070561','465a4a28febd46b2a5b300f91264a041']
            $.bean = 0;
