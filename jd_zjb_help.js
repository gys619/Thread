...
[task_local]
#柠檬赚金币
0,5 0 * * * http://nm66.top/jd_zjb.js, tag=柠檬赚金币, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env('赚金币邀请');
...
!(async () => {
     ...
     do {
          ...
          dddd++
     } while (dddd < InviterPin.length)// 1 2 //2 3
})()
     .catch((e) => {
          $.log('', `❌ ${$.name}, 失败! 原因: ${e}!`, '')
     })
