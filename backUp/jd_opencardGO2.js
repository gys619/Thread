...
/*
 10.23~29 大牌联合 狂欢抢先GO [jd_opencardGO2.js]
一次性开卡脚本
...
第一个账号助力作者 其他依次助力CK1
————————————————
入口：[ 10.23~29 大牌联合 狂欢抢先GO (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dz20211023wkcn14cn5cnd0sdbs5sbx&shareUuid=968074affb504b9e910d532984ef4714)]
...
const $ = new Env("10.23~29 大牌联合 狂欢抢先GO");
...
!(async () => {
    ...
    console.log(`入口：\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dz20211023wkcn14cn5cnd0sdbs5sbx&shareUuid=968074affb504b9e910d532984ef4714`);
    
    authorCodeList = ['968074affb504b9e910d532984ef4714']
...
async function rush() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            if ($.index==1) $.authorCode = '968074affb504b9e910d532984ef4714'
