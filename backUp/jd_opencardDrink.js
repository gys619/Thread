/*
8.31-9.21 中秋酒水 [jd_opencardDrink.js]
新增开卡脚本
一次性脚本
...
关注10京豆 (有可能是空气💨
加购没有豆只有金币 (有可能是空气💨 默认不加购 如需加购请设置环境变量[opencardDrink_addSku]为"true"
...
————————————————
入口：[8.31-9.21 中秋酒水 (https://lzdz1-isv.isvjcloud.com/dingzhi/jddrinks/grandceremony/activity/1988328?activityId=dz2108100001566301&shareUuid=c9c23a12a9a149ae877b516351311dbf)]

============Quantumultx===============
[task_local]
#8.31-9.21 中秋酒水
30 7,18 1-21 9 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardDrink.js, tag=8.31-9.21 中秋酒水, enabled=true

================Loon==============
[Script]
cron "30 7,18 1-21 9 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardDrink.js, tag=8.31-9.21 中秋酒水

===============Surge=================
8.31-9.21 中秋酒水 = type=cron,cronexp="30 7,18 1-21 9 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardDrink.js

============小火箭=========
8.31-9.21 中秋酒水 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardDrink.js, cronexpr="30 7,18 1-21 9 *", timeout=3600, enable=true
*/
...
guaopencard_addSku = $.isNode() ? (process.env.opencardDrink_addSku ? process.env.opencardDrink_addSku : `${guaopencard_addSku}`) : ($.getdata('opencardDrink_addSku') ? $.getdata('opencardDrink_addSku') : `${guaopencard_addSku}`);
...
!(async () => {
  ...
  $.shareUuidArr = [];
  $.shareUuid = 'c9c23a12a9a149ae877b516351311dbf'
...
async function run(){
  try{
    ...
    }else console.log('如需加购请设置环境变量[opencardDrink_addSku]为"true"');
