...
5 20,23 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_summer_movement_exchange.js,
 ...
 **/
 ...
 async function main(){
     ...
     if(Number($.userInfo.poolMoney)<5){
         return ;
     }
     await $.wait(1000);
     console.log(`兑换红包`);
 ...
 async function takePostRequest(type) {
     ...
     switch (type) {
         ...
         case 'olympicgames_withdraw':
             body = `functionId=olympicgames_withdraw&body={}&client=wh5&clientVersion=1.0.0&uuid=${uuid}&appid=o2_act`;
             myRequest = await getPostRequest(body);
             break;
         default:
             console.log(`错误${type}`);
