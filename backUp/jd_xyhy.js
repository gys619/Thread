...
[task_local]
#1.6-1.31 轩辕虎越,风生水起
23 3,16 6-31 1 * jd_xyhy.js, tag=1.6-1.31 轩辕虎越,风生水起, enabled=true
*/
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '4d34f6b5c7164e9fa5c45366e92470b0',
            ]
            $.bean = 0;
