...
/*
10.8~18 金秋好物盛典 [jd_opencardAHW.js]
 一次性脚本
 1.邀请可能20豆
 2.开8张卡 成功开1个 获得1次抽奖可能30京豆或实物
 3.加购5京豆
 第一个账号助力作者 其他依次助力CK1
 ————————————————
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.bean = 0;
            $.authorCode = ownCode ? ownCode : 'd65438b1f1ee42f6bbd36b1650729c13'
            $.authorNum = `${random(1000000, 9999999)}`
            $.activityId = 'dz20210929skcnurdk34jkkl3dsf4awqw'
...
async function marry() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            if($.index==1) $.authorCode = 'd65438b1f1ee42f6bbd36b1650729c13';
