...
await dotask("48m6GFduJrYy9Ku53YdSnzxiiEMB",null,0)

await dotask("6apdfDtEa4ujkDcE9unN6udx2t4",1000118193,0)

await dotask("b41we4YXBVcCCkGQgZjzFNaACdK",5301536544,0)
await dotask("b41we4YXBVcCCkGQgZjzFNaACdK",5301536544,1)
await dotask("b41we4YXBVcCCkGQgZjzFNaACdK",5301536544,0)
await dotask("3oaCLGRrD1DjNZD9tLkzkequj1zE","S5KkcA2dzsz2scVii_Ypt",0)
...
async function dotask(encryptAssignmentId,itemId,actionType){
 return new Promise((resolve) => {
    
 let plant6_url = {
   		url:  `https://api.m.jd.com/api?functionId=superBrandDoTask&appid=ProductZ4Brand&client=wh5&t=1626368092673&body={"source":"secondfloor","activityId":1000030,"encryptProjectId":"39ub2QthL9V4YeC165Xcp6DvQuMJ","encryptAssignmentId":"${encryptAssignmentId}","assignmentType":7,"completionFlag":1,"itemId":"${itemId}","actionType":${actionType}}`,
...
async function cj(){
 ...
 let plant6_url = {
   		url: 'https://api.m.jd.com/api?functionId=superBrandTaskLottery&appid=ProductZ4Brand&client=wh5&t=1626368639330&body={"source":"secondfloor","activityId":1000030}',
