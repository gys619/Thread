/*
9.3-9.13 奔跑吧 开学季 [jd_opencardSchool.js]
新增开卡脚本
一次性脚本
...
关注10京豆 (有可能是空气💨
加购没有豆只有游戏机会 (有可能是空气💨 默认不加购 如需加购请设置环境变量[opencardSchool_addSku]为"true"
抽奖 (有可能是空气💨 默认不抽奖 如需抽奖请设置环境变量[opencardSchool_draw]为"true"
100积分抽1次
填写要抽奖的次数 不足已自身次数为准
opencardSchool_draw="3"

第一个账号助力作者 其他依次助力CK1
第一个CK失效会退出脚本

————————————————
入口：[9.3-9.13 奔跑吧 开学季 (https://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/2451572?activityId=902090301&shareUuid=57cb8532ed6b450ab6260f780dbbb877)]

============Quantumultx===============
[task_local]
#9.3-9.13 奔跑吧 开学季
34 8,18 3-13 9 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardSchool.js, tag=9.3-9.13 奔跑吧 开学季, enabled=true

================Loon==============
[Script]
cron "34 8,18 3-13 9 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardSchool.js, tag=9.3-9.13 奔跑吧 开学季

===============Surge=================
9.3-9.13 奔跑吧 开学季 = type=cron,cronexp="34 8,18 3-13 9 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardSchool.js

============小火箭=========
9.3-9.13 奔跑吧 开学季 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardSchool.js, cronexpr="34 8,18 3-13 9 *", timeout=3600, enable=true
*/
...
guaopencard_addSku = $.isNode() ? (process.env.opencardSchool_addSku ? process.env.opencardSchool_addSku : guaopencard_addSku) : ($.getdata('opencardSchool_addSku') ? $.getdata('opencardSchool_addSku') : guaopencard_addSku);
let guaopencard_draw = "0"
guaopencard_draw = $.isNode() ? (process.env.opencardSchool_draw ? process.env.opencardSchool_draw : guaopencard_draw) : ($.getdata('opencardSchool_draw') ? $.getdata('opencardSchool_draw') : guaopencard_draw);
...
!(async () => {
  ...
  $.shareUuid = '57cb8532ed6b450ab6260f780dbbb877'
...
async function run(){
  try{
    ...
    }else console.log('如需加购请设置环境变量[opencardSchool_addSku]为"true"');
    ...
    }else console.log('如需抽奖请设置环境变量[opencardSchool_draw]为"true"');
    if(gameFlag == 1){
      await $.wait(parseInt(Math.random() * 1000 + 2000, 10))
      await getActorUuid()
      await $.wait(parseInt(Math.random() * 1000 + 2000, 10))
