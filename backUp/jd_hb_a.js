/**
开新红包
入口：https://u.jd.com/YLvI6zb
cron 10 0,12 * * * jd_hb_a.js
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        if (cookiesArr[i]) {
            ...
            lng = '30.' + random(99999999999999, 10000000000000);
            lat = '114.' + random(99999999999999, 10000000000000);
            await main();
        }
    }
...
async function main() {
    let hbInfo = await task()
    if (hbInfo.code === "0") {
        if (hbInfo.subCode === "0") {
            console.log(JSON.stringify(hbInfo.rewardsInfo));
        } else if (hbInfo.subCode === "103") {
            console.log(hbInfo.msg);
        } else {
            console.log(hbInfo);
        }
    }
...
function task() {
    let opt = {
        ...
        headers: {
            ...
            "Referer": "https://prodev.m.jd.com/mall/active/3EiRJz64mjsqY44PinYgmNTrQMfD/index.html",
