...
/*
 10.15~31 惠聚京东 好物连连 [jd_opencardLL2.js]
新增开卡脚本 (脚本已加密
一次性脚本

1.邀请一人20豆
2.开7张 成功开1张 获得1次抽奖,抽奖可能获得666京豆
3.关注5豆
4.加购0京豆 1次游戏机会
5.浏览商品0豆 2次游戏机会
第一个账号助力作者 其他依次助力CK1
————————————————
入口：[ 10.15~31 惠聚京东 好物连连 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/5063373?activityId=llk20211015&shareUuid=d2821481735c4e2c9b2e2ce5612a82c6)]
...
!(async () => {
    ...
    console.log(`入口：\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/5063373?activityId=llk20211015&shareUuid=d2821481735c4e2c9b2e2ce5612a82c6`)
    authorCodeList = ['d2821481735c4e2c9b2e2ce5612a82c6']
...
async function member() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            if ($.index==1) $.authorCode = 'd2821481735c4e2c9b2e2ce5612a82c6';
