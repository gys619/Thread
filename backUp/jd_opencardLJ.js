/*
9.18~9.28 礼遇中秋 家团圆 [jd_opencardLJ.js]
一次性开卡脚本
...
第一个CK失效会退出脚本
————————————————
入口：[9.18~9.28 礼遇中秋 家团圆 (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=21h3i1h3h2u1h3g43gy4g3yu2u23u423&shareUuid=1e3cf03cdb82470ea3ad0d3b0640ed93)]
IOS等用户直接用NobyDa的jd cookie
============Quantumultx===============
[task_local]
#9.18~9.28 礼遇中秋 家团圆
40 5,20 18-28 9 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLJ.js, tag=9.18~9.28 礼遇中秋 家团圆, enabled=true
================Loon==============
[Script]
cron "40 5,20 18-28 9 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLJ.js,tag=9.18~9.28 礼遇中秋 家团圆
===============Surge=================
9.18~9.28 礼遇中秋 家团圆 = type=cron,cronexp="40 5,20 18-28 9 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLJ.js
============小火箭=========
9.18~9.28 礼遇中秋 家团圆 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLJ.js, cronexpr="40 5,20 18-28 9 *", timeout=3600, enable=true
*/

const $ = new Env("礼遇中秋 家团圆");
...
!(async () => {
    ...
    console.log(`入口：\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=21h3i1h3h2u1h3g43gy4g3yu2u23u423&shareUuid=1e3cf03cdb82470ea3ad0d3b0640ed93`)
        ...
        $.post(taskUrl(function_id, body, isCommon), async (err, resp, data) => {
            try {
                if (err) {
                    ...
                    if($.index==1) $.authorCode = '1e3cf03cdb82470ea3ad0d3b0640ed93'
                    if (data) {
