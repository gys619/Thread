...
需要算法支持
默认：不执行 如需要请添加环境变量
export WindfggToken="" # WindfggToken
export gua_cleancart_Run="true" ## 运行清空购物车脚本
export gua_cleancart_products="*@&@" ##清空去不
——————————————
1.@&@ 前面加数字 指定账号pin
如果有中文请填写中文
2.|-| 账号之间隔开
...
*/
let jdSignUrl = 'https://api.windfgg.cf/jd/sign'
let jdWindfggToken = ''
let cleancartRun = 'false'
let cleancartProducts = ''
let lnrequesttimes=0
const $ = new Env('清空购物车_Windfgg');
