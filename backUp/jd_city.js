...
[task_local]
#城城领现金
0 11,0-23/5 9-21 1 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_city.js, tag=城城领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `http://www.helpu.cf/jdcodes/getcode.php?type=city&num=20`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
