/*
10.25~11.12 立即入会 瓜分百万京豆 [jd_opencardBean.js]
新增开卡脚本, 一次性脚本
...
第一个账号助力作者 其他依次助力CK1
入口：[ 10.25~11.12 立即入会 瓜分百万京豆 (https://lzdz1-isv.isvjcloud.com/dingzhi/fashion/recruit/activity?activityId=cfc218d9250d445a870b3c18b58b5475&shareUuid=09e46d6240924c2a911a4c0e73f0e8f5)]
...
!(async () => {
    ...
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/fashion/recruit/activity?activityId=cfc218d9250d445a870b3c18b58b5475&shareUuid=09e46d6240924c2a911a4c0e73f0e8f5`);
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['09e46d6240924c2a911a4c0e73f0e8f5']
            $.bean = 0;
...
async function rush() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            await $.wait(2000)
            if ($.index==1) $.authorCode = '09e46d6240924c2a911a4c0e73f0e8f5';
            ...
            if ($.activityContent) {
                for(let i in $.openInfo){
                    ...
                    if(!$.openInfo[i]['openStatus']){
                        ...
                        console.log("已加入会员: "+$.openInfo[i]['venderId'])
                    }
                }
                console.log("关注店铺")
