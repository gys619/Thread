...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/TongLin138/Test/main/utils/empty.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/TongLin138/Test@main/utils/empty.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/TongLin138/Test@main/utils/empty.json')
  }
