/*
10.8~10.14 超店会员福利社 [jd_opencardSVIP.js]
一次性脚本
1.邀请一人30豆
2.开21张卡 成功开1个 获得1次抽奖
  抽奖可能获得5/888京豆
3.关注15豆
4.加购3京豆
第一个账号助力作者 其他依次助力CK1
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['6862ef46c9414e9897ebd1cd66a31201']
            $.bean = 0;
...
async function superFans() {
    ...
    if ($.token) {
        await getMyPing();
        if ($.secretPin) {
            if ($.index==1) $.authorCode = '6862ef46c9414e9897ebd1cd66a31201';
