...
1.邀请一人可能30豆
2.开23张 成功开1张 获得1次抽奖,抽奖可能获得888、5、10京豆
3.关注可能15豆
4.每日加购可能3京豆

第一个账号助力作者 其他依次助力CK1
————————————————
入口：[ 11.11 超店会员福利社 (https://lzdz1-isv.isvjcloud.com/dingzhi/shop/league/activity/6898593?activityId=dz211026100001616201shop&shareUuid=1b0d6c6cf25a44b19b6440883a20e54d)]
请求太频繁会被黑ip
过10分钟再执行
============Quantumultx===============
[task_local]
#11.11超店会员福利社
36 1,12 1-11 11 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLH10.js, tag=11.11 超店会员福利社, enabled=true
*/
...
!(async () => {
    ...
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/shop/league/activity/6898593?activityId=dz211026100001616201shop&shareUuid=1b0d6c6cf25a44b19b6440883a20e54d`)
    let authorCodeList = ['1b0d6c6cf25a44b19b6440883a20e54d']
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityId = 'dz211026100001616201shop'
        ...
        if ($.secretPin) {
            ...
            if ($.activityContent) {
                ...
                if ($.openCardStatus) {
                    ...
                    if (taskList.length)console.log(taskList.length);
