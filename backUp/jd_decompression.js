 ...
 * 第一个号会给作者助力，其他号会给第一个号助力，活动期间貌似只有一次助力机会
 cron  5 6,18 1-16,21-30 9,10 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_decompression.js
 */
...
function getAuthorShareCode(url='https://raw.githubusercontent.com/he1pu/params/main/decompression.json') {
    return new Promise(async resolve => {
        const options = {
            "url": `${url}`,
            "timeout": 10000,
