/*
12.20~1.5 双旦寻宝 玩转大富翁 [jd_opencardLH30.js]
开卡脚本,一次性脚本
...
————————————————
入口：[ 12.20~1.5 双旦寻宝 玩转大富翁 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dfw2021121702rics9xrkw5mpka&shareUuid=3672a22556a44a3bbdcf51b99f42908b)]

请求太频繁会被黑ip
过10分钟再执行

cron:30 0,8 21-31/2,2-5/2 12,1 *
============Quantumultx===============
[task_local]
#12.20~1.5 双旦寻宝 玩转大富翁
30 0,8 21-31/2,2-5/2 12,1 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLH30.js, tag=12.20~1.5 双旦寻宝 玩转大富翁, enabled=true
...
!(async () => {
  ...
  $.shareUuid = "3672a22556a44a3bbdcf51b99f42908b"
