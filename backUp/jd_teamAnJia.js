...
[task_local]
#组队分豆-安佳
1 0,22 * * * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_teamAnJia.js, tag=组队分豆-安佳, enabled=true
================Loon==============
[Script]
cron "1 0,22 * * *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_teamAnJia.js,tag=组队分豆-安佳
===============Surge=================
组队分豆-安佳 = type=cron,cronexp="1 0,22 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_teamAnJia.js
============小火箭=========
组队分豆-安佳 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_teamAnJia.js, cronexpr="1 0,22 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['6ca772dad0f94698937bc4fbdbdb5521']
            $.bean = 0;
