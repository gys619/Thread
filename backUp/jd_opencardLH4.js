...
/*
11.1~11 大牌联合4 [jd_opencardLH4.js]
一次性开卡脚本
第一个账号助力作者 其他依次助力CK1

https://jinggengjcq-isv.isvjcloud.com/fronth5/#/pages/unitedCardNew2021110103/unitedCardNew2021110103?actId=c3860ccdb6a24de5b773ea_11014
============Quantumultx===============
[task_local]
#11.1~11 大牌联合4
21 3,14 1-11 11 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardLH4.js, tag=11.1~11 大牌联合4, enabled=true
*/

const $ = new Env("11.1~11 大牌联合4");
...
!(async () => {
    ...
    let authorCodeList = ['P2sTlitT1/47lgUP4KvMwF4tLNYA4seuA67MOIYQxEk3Vl9+AVo4NF+tgyeIc6A6kdK3rLBQpEQH9V4tdrrh0w==']
...
async function openCardNew() {
    ...
    if ($.token) {
        ...
        if ($.buyerNick) {
            ...
            if ($.index === 1) {
                $.authorCode='P2sTlitT1/47lgUP4KvMwF4tLNYA4seuA67MOIYQxEk3Vl9+AVo4NF+tgyeIc6A6kdK3rLBQpEQH9V4tdrrh0w==';
                ownCode = $.buyerNick
