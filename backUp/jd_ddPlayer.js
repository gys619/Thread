...
[task_local]
#东东玩家
20 0,4 * * * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_ddPlayer.js, tag= 东东玩家
================Loon==============
[Script]
cron "20 0,4 * * *" script-path= https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_ddPlayer.js,tag= 东东玩家
===============Surge=================
东东玩家 = type=cron,cronexp="20 0,4 * * *",wake-system=1,timeout=3600,script-path= https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_ddPlayer.js
============小火箭=========
东东玩家 = type=cron,script-path= https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_ddPlayer.js, cronexpr="20 0,4 * * *", timeout=3600, enable=true
from：https://github.com/Ariszy/Private-Script
*/
const $ = new Env('东东玩家')
...
CodeArr = []
cookie = ''
var list2tokenArr = [],list1tokenArr = [],list2tokenArr = [],listtokenArr = [],list0tokenArr = [],list1tokenArr = []
...
async function control(){
   ...
   if (i==0 && $.index==1)  helpcode = 'T0225KkcREoe9wXXJ0_wkPFbcQFjRWn627yB55awQ';
   await dosupport()
   await $.wait(4000)
}
}
