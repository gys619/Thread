...
[task_local]
#jd免费水果
5 6-18/6 * * * jd_test.js, tag=京东测试, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" script-path=jd_test.js,tag=京东测试
=========================Surge============================
京东测试 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=3600,script-path=jd_test.js
=========================小火箭===========================
京东测试 = type=cron,script-path=jd_test.js, cronexpr="5 6-18/6 * * *", timeout=3600, enable=true
*/
const $ = new Env('京东测试');
