...
然后填写[task_after.sh](https://raw.githubusercontent.com/gys619/Absinthe/main/config/task_after.sh)
(仓库内的仅供参考)


青龙2.13版本互助，用[task_after2.sh](https://raw.githubusercontent.com/gys619/Absinthe/main/config/task_after2.sh) 可以加个定时
