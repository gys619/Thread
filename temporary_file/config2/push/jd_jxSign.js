...
[task_local]
#京喜签到
20 1,7 * * * jx_sign.js, tag=京喜签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "20 1,7 * * *" script-path=jx_sign.js,tag=京喜签到
          ...
          switch (type) {
            case 1:
              if (status === 1) {
                ...
                if ($.index==cookiesArr.length) $.shareCodes.push({'use': 'jdU','smp': '60a620f96e505406586b8e249eda3ad8','num': 0,'max': false})
              }
              break
            case 2:
