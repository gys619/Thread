...
## 多账号
export gua_cleancart_products="pin@&@商品,商品|-|pin@&@|-|pin@&@商品"
## 多账号 不指定的全清空
export gua_cleancart_products="pin@&@商品,商品|-|pin@&@|-|pin@&@商品|-|*@&@"
...
!(async () => {
    ...
    console.log('环境变量添加：export gua_cleancart_Run="true",当环境变量中存在gua_cleancart_Run并设置为true时才会执行删除购物车\n')
	console.log('环境变量添加：export gua_cleancart_SignUrl="https://jd.smiek.tk/jdcleancatr_21102717" # 算法url\n')
  if (!cookiesArr[0]) {
