...
[task_local]
#京东直播
50 12-14 * * * jd_live.js, tag=京东直播, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "50 12-14 * * *" script-path=jd_live.js,tag=京东直播

===============Surge=================
京东直播 = type=cron,cronexp="50 12-14 * * *",wake-system=1,timeout=3600,script-path=jd_live.js

============小火箭=========
京东直播 = type=cron,script-path=jd_live.js, cronexpr="50 12-14 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东直播');
