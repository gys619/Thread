...
第一个CK失效会退出脚本
————————————————
入口：[ 7.18-7.25酷玩一夏 冰爽放价 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/8938022?activityId=dzlhkkde95c4481a4859f30fa6f5868]
...
!(async () => {
  ...
  $.shareUuid = "6846bac90410429fb81f41ec409ecab4"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = ['6846bac90410429fb81f41ec409ecab4','5dc79c93cc0e4605a1e59b146249e73b']
